...
extension RGB565Color {
	...
	public var rgbaValue: RGBAColor {
	...
	public var red:   UInt16 { return (self >> 11) & 0x1F }
	
	/// the green component of a RGB565 pixel (6 bits)
	public var green: UInt16 { return (self >> 5)  & 0x3F }
	
	/// the blue component of a RGB565 pixel (5 bits)
	public var blue:  UInt16 { return (self)       & 0x1F }
	
	/// pack red, green, blue values into a single RGB565 pixel value
	public static func pack(red: UInt16, green: UInt16, blue: UInt16) -> RGB565Color {
